 ...
 */
package com.flamesgroup.poweradius.test;

import java.io.IOException;

import com.flamesgroup.poweradius.packet.AccessRequest;
import com.flamesgroup.poweradius.packet.AccountingRequest;
import com.flamesgroup.poweradius.packet.RadiusPacket;
import com.flamesgroup.poweradius.util.RadiusClient;
import com.flamesgroup.poweradius.util.RadiusException;
...
public class TestClient {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * System.exit(1); }
		 * 
		 * String host = args[0]; String shared = args[1]; String user =
		 * args[2]; String pass = args[3];
		 */
			...
			public void run() {
				...
				for (int i = 1; i<3000; i++){*/
					try {
						...
						ar.setAuthProtocol(AccessRequest.AUTH_PAP); // or
																	// AUTH_CHAP
						ar.addAttribute("NAS-Identifier",
								"this.is.my.nas-identifier.de");
						ar.addAttribute("NAS-IP-Address", "192.168.0.100");
						ar.addAttribute("Service-Type", "Login-User");
						ar.addAttribute("WISPr-Redirection-URL",
								"http://www.sourceforge.net/");
						ar.addAttribute("WISPr-Location-ID",
								"net.sourceforge.ap1");
						...
						acc.addAttribute("NAS-Identifier",
								"this.is.my.nas-identifier.de");
